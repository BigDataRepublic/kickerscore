...
import {Col, Container, ListGroup, ListGroupItem, Popover, PopoverBody, PopoverHeader, Row} from "reactstrap";
...
import {getPlayers, postMatch, postPlayerAnalysis, postTeamAnalysis} from "../../ApiClient";
import TakePhotoComponent from "./TakePhotoComponent";

class AddPhotoMatchForm extends Component {
    constructor() {
        super();
        this.state = {
            addingMatch: false,
...
export default AddPhotoMatchForm;
